...
## Objective
Maintain `rag-cli` as a reliable, useful, and test-first project aligned with its primary promise:
> CLI for the full RAG lifecycle: ingest, query, evaluation, and gap analysis.
